...
public class OneImagePool {
    ...
    public Object[] info(int filter_flag, int range_start_ID, int range_end_ID) throws XmlRpcException{
        Object[] params = {session, filter_flag, range_start_ID, range_start_ID};

        Object[] result = (Object[])this.client.execute("one.imagepool.info",params);
